IMPOSSIBLE DE METTRE L'APPLICATION SUR MYLEARNINGBOX (40Mo trop petit)
...
L'application permet de stocker ses anciens QrCode générer, en l'ajoutant tout simplement dans
sa liste.


Pour faire fonctionner l'application, il faut faire tourner le back (Spring/JAVA), qui est
relié à une database nommée hangqrcoute : 
	- identifiant : root
	- mdp: root
